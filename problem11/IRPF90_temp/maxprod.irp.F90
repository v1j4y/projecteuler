...
subroutine bld_maxprod
  ...
  character*(7) :: irp_here = 'maxprod'                             ! maxprod.irp.f:   1
    ...
    do i=1,1000                                                     ! maxprod.irp.f:  12
        if(prodlist(i).ge.maxprod) then                             ! maxprod.irp.f:  13
maxprod=prodlist(i)                                                 ! maxprod.irp.f:  13
  endif                                                             ! maxprod.irp.f:  13
    enddo                                                           ! maxprod.irp.f:  15
