SRC += IRPF90_temp/irp_stack.irp.F90 IRPF90_temp/irp_touches.irp.F90 IRPF90_temp/prime.irp.F90 IRPF90_temp/prime.irp.module.F90 IRPF90_temp/is_prime.irp.F90 IRPF90_temp/is_prime.irp.module.F90
OBJ += IRPF90_temp/irp_stack.irp.o IRPF90_temp/is_prime.irp.o IRPF90_temp/is_prime.irp.module.o
OBJ1 = $(patsubst %, IRPF90_temp/%,$(notdir $(OBJ))) IRPF90_temp/irp_touches.irp.o 
ALL = prime
ALL_OBJ = prime.irp.module.o prime.irp.o
ALL_OBJ1 = $(patsubst %, IRPF90_temp/%,$(notdir $(ALL_OBJ)))
all:$(ALL)
	@$(MAKE) -s move
prime: IRPF90_temp/prime.irp.o IRPF90_temp/prime.irp.module.o $(OBJ1)
	$(FC) -o $@ IRPF90_temp/$@.irp.o IRPF90_temp/$@.irp.module.o $(OBJ1) $(LIB)
	@$(MAKE) -s move
IRPF90_temp/prime.irp.o: IRPF90_temp/prime.irp.module.o  
IRPF90_temp/is_prime.irp.o: IRPF90_temp/is_prime.irp.module.o  
IRPF90_temp/irp_touches.irp.o:  IRPF90_temp/is_prime.irp.o IRPF90_temp/is_prime.irp.o
